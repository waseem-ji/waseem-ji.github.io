...
<div class="cookie-policy-p">
  <p>
    ...
    of cookies we use i.e, the information we collect using cookies and how that
  ...
  <p>
    ...
    your browser. These cookies help us make the website function properly, make
    it more secure, provide better user experience, and understand how the
...
<div class="cookie-policy-p">
  ...
  <p>
    ...
    services secure, providing advertisements that are relevant to you, and all
    in all providing you with a better and improved user experience and help
...
<div>
  <p>
    ...
    button. This will let you revisit the cookie consent banner and change your
  ...
  <p>
    ...
    browser to block/delete the cookies. Listed below are the links to the
    support documents on how to manage and delete cookies from the major web
    browsers.
  </p>
  <p>
    Chrome:
...
<p class="cookie-policy-p">
  ...
  <a
    ...
    >CookieYes - Cookie Policy Generator</a
  >.
</p>
